...
// 
// 3. Challenge: Setup the "Expenses Reducer" and its "Expenses Reducer Test Case" for our new 'setExpenses()' Action Generator
// 
/******************************************************************************************************************************************************/
 ...
 *
 * 2. Asynchronus Start Action Steps w/ Firebase
 *  - 1st: Components calls "Asynchronous Start Action Generator"
 *  - 2nd: "Asynchronous Start Action Generator" returns "Function()"
 *  - 3rd: Component "Dispatches" a function()
 ...
 *      (In this case our Front End Component is "Dispatching" a "Asynchronous Start Action Generator Function" => That returns a "Function()" )
 ...
 *       - 'startAddExpense()': Returns a "Function()" that is going to start the process off => "Dispatching" 'addExpense()' inside of the function() itself
